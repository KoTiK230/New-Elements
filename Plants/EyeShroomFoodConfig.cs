...
{
    class EyeShroomFoodConfig : IEntityConfig
    {
        public static string ID = "EyeShroomFood";
        public static string NAME = UI.FormatAsLink("Eye Shroom Food", ID.ToUpper());
        public static string DESC = "Их едят - они глядят";
        public const int quality = TUNING.FOOD.FOOD_QUALITY_MEDIOCRE;
        public const float caloriesPerUnit = 2000f * 1000f;
