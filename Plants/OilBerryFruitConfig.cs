...
{
    class OilBerryFruitConfig : IEntityConfig
    {
        public static string ID = "OilBerryFruit";
        public static string NAME = UI.FormatAsLink("OilBerries", ID.ToUpper());
        public static string DESC = "bleh";
